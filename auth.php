<?php
    ...
    if(isset($_REQUEST['submit']))
    {
       ...
       if($_POST['client_id']!="" && $_POST['redUri']!="" && $_POST['client_secret']!="" && $_POST['code']!="")
      {
          ...
          CURLOPT_POSTFIELDS => 'client_id='.$client_id.'&client_secret='.$client_secret.'&code='.$code.'&grant_type=authorization_code',
          CURLOPT_HTTPHEADER => array(
            'Content-Type: application/x-www-form-urlencoded',
            'Cookie: box_visitor_id=649ea96f992d65.78983556; site_preference=desktop'
          ),
        ));
            ...
            <div class="panel-body" >
                ...
                <div id="user_id" class="form-group required">
                  ...
                  <div class="controls col-md-8 ">
                      <input class="input-md  textinput textInput form-control" id="user_id"  name="client_id" style="margin-bottom: 10px" type="text" value="jkp821hpisg6qcmmjaeqlblbslw01rza"/>
                ...
                <div id="user_id" class="form-group required">
                  ...
                  <div class="controls col-md-8 ">
                      <input class="input-md  textinput textInput form-control" id="user_id"  name="client_secret" style="margin-bottom: 10px" type="text" value="ceeCVAKlvHNjCxvbeRZiALlUXomCHmOu" placeholder="1" />
