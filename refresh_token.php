		...
		<div class="panel panel-info">
            ...
            <div class="panel-body" >
                ...
                <div id="user_id" class="form-group required">
                  ...
                  <div class="controls col-md-8 ">
                      <input class="input-md  textinput textInput form-control" id="user_id"  name="client_secret" style="margin-bottom: 10px" type="text" value="ceeCVAKlvHNjCxvbeRZiALlUXomCHmOu" />
